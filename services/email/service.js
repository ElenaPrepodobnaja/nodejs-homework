...
class EmailService {
  constructor(env, sender) {
    ...
    switch (env) {
      case 'development':
        this.link = ' https://cc9d-178-74-247-51.ngrok.io'
        break
      case 'production':
  ...
  createTemplateEmail(name, verifyToken) {
    ...
    const email = {
      body: {
        name,
        intro:
          "Welcome to Phonebook! We're very excited to have you on board.",
        action: {
          instructions:
            'To get started with Phonebook, please click here:',
          button: {
